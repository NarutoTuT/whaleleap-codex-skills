...
const SKILLS_DIR = process.env.CODEX_SKILLS_DIR || path.join(os.homedir(), '.agents', 'skills');
const GENERATE_TOKENS_SCRIPT = path.join(SKILLS_DIR, 'design-system', 'scripts', 'generate-tokens.cjs');
